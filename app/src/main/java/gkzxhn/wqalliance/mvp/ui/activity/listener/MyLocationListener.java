package gkzxhn.wqalliance.mvp.ui.activity.listener;
...
public class MyLocationListener implements BDLocationListener {
    ...
    private Activity mFightFakeActivity;

    public MyLocationListener(Activity fightFakeActivity) {
        mFightFakeActivity = fightFakeActivity;
    }
    ...
    public void onReceiveLocation(BDLocation location) {
        ...
        ((FightFakeActivity) mFightFakeActivity).updateAddr(location.getAddrStr());
    ...
    public void onConnectHotSpotMessage(String s, int i) {
        ...
        Log.i(TAG, "onConnectHotSpotMessage: i  " + i);
    }
}
