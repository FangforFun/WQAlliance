...
import gkzxhn.wqalliance.mvp.model.MyOrderModel;
...
/**
 * Created by huangzhengneng on 2017/3/6.
 */
...
public class MyOrderModule {
    ...
    @ActivityScope
    @Provides
    MyOrderContract.View provideMainView() {
        return this.view;
    }

    @ActivityScope
    @Provides
    MyOrderContract.Model provideMainModel(MyOrderModel model) {
        return model;
    }
}